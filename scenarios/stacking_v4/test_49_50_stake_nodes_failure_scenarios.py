...
def test_49_50_stake_nodes_failure_scenarios(blockchain, epoch):
    ...
    # invalid_key = ValidatorKey(Path(VALIDATOR_KEYS_FOLDER + "/invalid_bls_key_1.pem"))
    # normal_key = ValidatorKey(Path(VALIDATOR_KEYS_FOLDER + "/validatorKey_1.pem"))
    #
    ...
    _key = ValidatorKey(Path(VALIDATOR_KEYS_FOLDER + "/validatorKey_2.pem"))
    ...
    _key = ValidatorKey(Path(VALIDATOR_KEYS_FOLDER + "/validatorKey_3.pem"))
